...
| Rama | Descripción |
|------|-------------|
| **main** | Versión actual estable: equipos, jugadores, partidos, posiciones, árbitros, login, proxy API en Docker. |
| **development** | Rama de trabajo; se integra aquí por Pull Request. |
| **release** | Preparación de releases; merge desde development, luego a main. |
